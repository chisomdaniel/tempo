      ...
      <header className="layout-container">
        ...
        <section className="greeting">
          ...
          <div className="text-body-md flex flex-col items-start gap-2 md:flex-row md:items-center md:gap-4">
            ...
            <span className="chip">0 Scheduled Sessions</span>
          </div>
        </section>
      </header>
      <main className="layout-container flex flex-col gap-20 pt-12">
        <section className="time-card surface-card self-center my-8 md:p-12 p-6 rounded-r-3xl flex flex-col items-center gap-8">
          <div className="actions flex items-center gap-4">
            <button className="text-body-md btn-primary">Start new task</button>
          ...
          <div className="timer count-down flex flex-col items-center">
            <p className="text-headline-lg">13:06</p>
            <span className="chip">of 45:00 session</span>
          </div>
          <div className="timer clock flex flex-col items-center">
            <p className="text-headline-lg">12:05</p>
            <span className="chip">End at: 13:06</span>
          </div>
          <div className="controls flex justify-evenly gap-4">
            <button className="text-body-md btn-secondary rounded-full w-12 h-12 p-0 flex items-center justify-center">
              <svg
            ...
            <button className="text-body-md btn-primary flex align-middle items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
        ...
        <section className="today-history*:">
          <h2 className="text-headline-md mb-12">Today's Flow</h2>
          <div className="today-history flex flex-col gap-6">
            <div className="history-item">
              <p className="text-label-md pb-3">08:00</p>
              <div className="surface-card p-6 rounded-lg">
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-body-md">System Design Practice</h3>
                  <p className="text-label-md">30 Min</p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className="history-item">
              <p className="text-label-md pb-3">09:30</p>
              <div className="h-item surface-card p-6 rounded-lg">
                ...
                <div className="h-item flex flex-col gap-1">
                  <h3 className="text-body-md">Break</h3>
                  <p className="text-label-md">10 Min</p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className="history-item">
              <p className="text-label-md pb-3">09:40</p>
              <div className="h-item surface-card p-6 rounded-lg">
                <span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-body-md">Pet Care</h3>
                  <p className="text-label-md">45 Min</p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
